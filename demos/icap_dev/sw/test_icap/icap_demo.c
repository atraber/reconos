...
int hw_icap_reset_crc()
{
	int ret;

  unsigned int size = 16 * sizeof(uint32_t);
  uint32_t* read_blk = (uint32_t*)malloc(size);
  unsigned int i = 0;
  // step 1
  read_blk[i++]  = 0xFFFFFFFF;
  read_blk[i++]  = 0xFFFFFFFF;
  read_blk[i++]  = 0xFFFFFFFF;
  read_blk[i++]  = 0xFFFFFFFF;
  read_blk[i++]  = 0x000000BB;
  read_blk[i++]  = 0x11220044;
  read_blk[i++]  = 0xFFFFFFFF;
  read_blk[i++]  = 0xAA995566;
  // step 2
  read_blk[i++]  = 0x20000000;
  // step 4
  read_blk[i++]  = 0x30008001;
  read_blk[i++] = 0x00000007; // RCRC
  read_blk[i++] = 0x20000000;

  read_blk[i++] = 0x30008001;
  read_blk[i++] = 0x0000000D; // DESYNC
  read_blk[i++] = 0x20000000;
  read_blk[i++] = 0x20000000;

  unsigned int addr = (unsigned int)read_blk;
...
int hw_icap_change_icap()
{
	int ret;

  unsigned int size = 19 * sizeof(uint32_t);
  uint32_t* read_blk = (uint32_t*)malloc(size);
  unsigned int i = 0;
  ...
  read_blk[i++] = 0xFFFFFFFF;
  read_blk[i++] = 0x000000BB;
  read_blk[i++] = 0x11220044; // bit width detection
  read_blk[i++] = 0xFFFFFFFF;
  read_blk[i++] = 0xAA995566; // SYNC

  read_blk[i++] = 0x20000000; // NOOP

  read_blk[i++] = 0x3000C001; // TYPE 1, WRITE to MASK
  read_blk[i++] = 0x40000000; // MASK
  read_blk[i++] = 0x20000000; // NOOP

  read_blk[i++] = 0x3000A001; // TYPE 1, WRITE to CTL0
  read_blk[i++] = 0x40000000; // ICAP Select to Bottom
  read_blk[i++] = 0x20000000; // NOOP
...
int hw_icap_test_readback()
{
	int ret;

  unsigned int size = 55 * sizeof(uint32_t);
  uint32_t* read_blk = (uint32_t*)malloc(size);
  unsigned int i = 0;
  // step 1
  read_blk[i++]  = 0xFFFFFFFF;
  ...
  // step 3i++
  read_blk[i++]  = 0x30008001;
  read_blk[i++]  = 0x0000000B;
  read_blk[i++]  = 0x20000000;
  // step 4i++
  read_blk[i++]  = 0x30008001;
  read_blk[i++]  = 0x00000007;
  read_blk[i++] = 0x20000000;
  // step 5i++
  read_blk[i++] = 0x20000000;
  read_blk[i++] = 0x20000000;
  ...
  // step 6i++
  read_blk[i++]  = 0x30008001;
  read_blk[i++]  = 0x00000004;
  read_blk[i++] = 0x20000000;
  // step 7i++
  read_blk[i++]  = 0x30002001;
  read_blk[i++]  = 0x00000000;
  // step 8i++
  read_blk[i++]  = 0x28006000;
  read_blk[i++]  = 0x48024090;
  // step 9i++
  read_blk[i++]  = 0x20000000;
  read_blk[i++]  = 0x20000000;
  read_blk[i++]  = 0x20000000;
