...
cp ./imp/config_pr_a/system_hwt_pr_block_1_hwt_pr_a_partial.bin ./bitfiles/partial_add2.bin
cp ./imp/config_pr_a/system_hwt_pr_block_1_hwt_pr_a_partial.bit ./bitfiles/partial_add2.bit
...
cp ./imp/config_pr_b/system_hwt_pr_block_1_hwt_pr_b_partial.bin ./bitfiles/partial_sub2.bin
cp ./imp/config_pr_b/system_hwt_pr_block_1_hwt_pr_b_partial.bit ./bitfiles/partial_sub2.bit
